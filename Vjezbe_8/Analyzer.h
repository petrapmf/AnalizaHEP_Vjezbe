...
// Wed Nov 10 12:16:24 2021 by ROOT version 6.24/04
...
#include <iostream>
#include <cstdlib>
#include <TString.h> //dodano
#include <THStack.h> //dodano
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void Plot(TString path); //dodat
   virtual void DrawDkin(); //dodat
   virtual void Fit();
   virtual void FitML();
   TH1F* h_background;
   TH1F* h_signal;
